...
GeeksforGeeks was dropped from the Coding Profiles section — GFG's site blocks scraping from cloud IPs (Vercel's included) with a bot-protection challenge page, and the community API used as a workaround didn't expose enough real data to justify a card.
